...
Pour le texte dans le langage, on dit "représentation textuelle", "code", "texte dans le langage"
////
...
// Phrase toute seule = pas de connecteur logique (pas de "en effet")
// Pas convention, protocole
...
// Le superviseur n'est pas indépendant du parseur, c'est le protocole qui l'est
