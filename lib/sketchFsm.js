...
function Fsm(cfg) {
  ...
  addAccessors(Edge.prototype, "edges", data, {
    ...
    points: { check: check().iterable(), precedence: [
      function() { return copyPoints(data.edges.get(this).points); },
      function() { return copyPoints(data.edges.get(this).computedPoints); }
    ]},
    x: { check: checks.integer, precedence: [
  ...
  function computeLayout() {
    ...
    for(let e of graph.edges()) {
      ...
      edgeData.computedPoints = points;
