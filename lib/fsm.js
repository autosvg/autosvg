...
function Fsm(cfg) {
  ...
  class Symbol {
     ...
     */
    static add() {
      return addSymbol({}, new this(arguments), data);
    }
    /**
  ...
  class State {
    ...
    static add(descriptor, ...args) {
      ...
      return addState(descriptor, new this(arguments), data);
    }
  };
  ...
  class Transition {
    ...
    static add(descriptor) {
      ...
      descriptor = Object.assign({}, descriptor);
      if(check.error(descriptor)) return descriptor;
      return addTransition(descriptor, new this(arguments), data);
    }
    /**
    ...
    static select(selector) {
      ...
      if(check.error(selector)) return selector;
      let args = [];
